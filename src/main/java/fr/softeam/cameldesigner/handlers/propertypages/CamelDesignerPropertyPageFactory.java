...
import fr.softeam.cameldesigner.handlers.propertypages.execution.ActionInstancePropertyPage;
    ...
    private static class PropertyPageVisitor implements IDefaultModelVisitor, IDefaultInfrastructureVisitor {
        ...
        public final Object visitClass(Class obj) {
            switch (this.stName) {
                ...
                case fr.softeam.cameldesigner.api.executionmodel.standard.class_.ActionInstance.STEREOTYPE_NAME: return new ActionInstancePropertyPage<>(fr.softeam.cameldesigner.api.executionmodel.standard.class_.ActionInstance.instantiate(obj));
                ...
                case fr.softeam.cameldesigner.api.scalabilitymodel.standard.class_.NonFunctionalEventInstance.STEREOTYPE_NAME: return new NonFunctionalEventInstancePropertyPage<>(fr.softeam.cameldesigner.api.scalabilitymodel.standard.class_.NonFunctionalEventInstance.instantiate(obj));
                case fr.softeam.cameldesigner.api.scalabilitymodel.standard.class_.FunctionalEventInstance.STEREOTYPE_NAME: return new FunctionalEventInstancePropertyPage<>(fr.softeam.cameldesigner.api.scalabilitymodel.standard.class_.FunctionalEventInstance.instantiate(obj));
