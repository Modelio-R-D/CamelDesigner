...
public class DataInstance extends FeatureInstance {
    @objid ("578deb60-87ea-47f7-9be8-ac914c96da6b")
    ...
    @objid ("9a0c0f3f-455f-405d-aa93-66754c97fce4")
    ...
    public static final class MdaTypes {
        @objid ("845c41f9-9222-48cb-b585-87c33f26b48f")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("f5a2eb3c-49e7-4fc9-9ecd-e45469afca56")
        private static Stereotype MDAASSOCDEP;

        @objid ("c23b4c54-2675-471b-9c94-835f3c574bb5")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("354c4d47-16db-4664-963b-90260bfaa022")
