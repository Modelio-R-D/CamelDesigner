...
public class CamelDesignerProxyFactory {
    @objid ("04465ca2-e108-4bf0-b4ea-232d1a8ae32e")
     ...
     */
    @objid ("0df62899-8b23-4ab8-9e78-cce31b86d67d")
     ...
     * @return the right proxy or <i>null</i>.
     */
    @objid ("34d05e04-80e5-4f64-b570-6211a80f0038")
    public static final Object instantiate(final Element e, final String stName) {
        instantiateVisitor.setStereotype(stName);
        return e.accept(instantiateVisitor);
    }

    @objid ("6635d661-b332-4720-9cbe-eaf3741df036")
    private static class InstantiateVisitor implements IDefaultModelVisitor, IDefaultInfrastructureVisitor {
        @objid ("391c0574-3e9c-450e-8056-9134d65741dd")
        private String stName;

        @objid ("eb644f92-6664-4efd-89a8-59fe6321a94a")
        public final void setStereotype(final String stName) {
            this.stName = stName;
        }

        @objid ("d1cdc0c1-d7f2-4305-b76f-41be21bddc76")
        @Override
        ...
        @objid ("8cca7c75-e465-4895-b17b-ce5275f4e3c0")
        @Override
        ...
        @objid ("539b9dab-b9b5-4884-8668-3606c495f4c3")
        @Override
        ...
        @objid ("d49970e8-d7b3-466d-8a82-7b3738816ed1")
        @Override
        ...
        @objid ("4180c037-09ff-4d20-b254-8a0e2b67598d")
        @Override
        ...
        @objid ("62233c8a-1da0-49c6-97f3-77e6d05bcdfb")
        @Override
        ...
        @objid ("c118cfb3-842c-40b0-a0b9-12f1fb43a2ee")
        @Override
        ...
        @objid ("21e40409-1086-4c8e-91ed-827a4df0bcf2")
        @Override
        ...
        @objid ("750d2bc7-b7bb-45a7-9b84-7cb522b336ec")
        @Override
        ...
        @objid ("03ace8bb-3397-4c20-b7f1-019626fb0d84")
        @Override
        ...
        @objid ("841a2330-7bff-4fea-831b-d74150028558")
        @Override
        ...
        @objid ("f976a687-76c8-4ab0-b2db-7be2195c8215")
        @Override
        ...
        @objid ("54935cce-2474-4ac6-8e8b-30f51ca62633")
        @Override
        ...
        @objid ("77c61142-4581-4cea-a456-b23cdd81ed32")
        @Override
        ...
        @objid ("7cce2931-1b85-4abc-b523-3df92f8e968b")
        @Override
        ...
        @objid ("2a39c907-f31e-4e88-ad86-2e4443cf4a59")
        @Override
        ...
        @objid ("3c1ddea7-67ee-47d0-ab67-04dd8e38fe6a")
        @Override
        ...
        @objid ("7789b50d-a0a0-4921-a7f3-a600971139b0")
        @Override
         ...
         */
        @objid ("1b93bca7-323c-4021-a8da-a295c42f5f29")
        @Override
