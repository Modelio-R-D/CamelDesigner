...
public class CamelDesignerProxyFactory {
    @objid ("9d44c211-f1a8-4236-a2ea-22d72bd1279d")
    ...
    private static class InstantiateVisitor implements IDefaultModelVisitor, IDefaultInfrastructureVisitor {
        ...
        @objid ("a8d94a54-c035-40a1-af25-7538d07da8de")
        @Override
        public final Object visitStaticDiagram(StaticDiagram obj) {
            switch (this.stName) {
            	case fr.softeam.cameldesigner.api.automatic.standard.staticdiagram.DataInstanceDiagram.STEREOTYPE_NAME: return fr.softeam.cameldesigner.api.automatic.standard.staticdiagram.DataInstanceDiagram.instantiate(obj);
            	default:
            		break;
            }
        ...
        public final Object visitClassDiagram(ClassDiagram obj) {
            switch (this.stName) {
            	...
            	case fr.softeam.cameldesigner.api.automatic.standard.classdiagram.DeploymentInstanceDiagram.STEREOTYPE_NAME: return fr.softeam.cameldesigner.api.automatic.standard.classdiagram.DeploymentInstanceDiagram.instantiate(obj);
            	default:
            		break;
            }
