...
public abstract class Credentials extends FeatureClass {
    @objid ("851e427f-2a39-4732-8c38-f68ef67fbded")
    public static final String STEREOTYPE_NAME = "Credentials";

    @objid ("bcd476b3-b7ac-417f-87bc-1d5ff9cdf2c9")
    @Override
     ...
     */
    @objid ("2509882d-1bb3-4292-b348-937f5ee46176")
    @Override
    public Class getElement() {
        return (Class)super.getElement();
    }

    @objid ("4b7b7346-3100-413b-9319-69def404a00f")
    @Override
    public int hashCode() {
        return 23 + ((this.elt == null) ? 0 : this.elt.hashCode());
    }

    @objid ("899322d3-2ff8-43e6-9311-48c88676e59e")
    ...
    public static final class MdaTypes {
        @objid ("b7b570e4-41dc-46d7-a006-6a9fd41d7d94")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("73bc42b2-f775-45a4-9feb-8f4ec1876c1e")
        private static Stereotype MDAASSOCDEP;

        @objid ("ba9dc929-cf3e-46a9-8ed0-129116cf210c")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("253ba746-96ee-4b9e-9acc-92eacbf6f182")
