...
public abstract class Unit extends Feature {
    ...
    public static Unit instantiate(final DataType obj) {
        ...
        }else if (SingleUnit.canInstantiate(obj)) {
            return new SingleUnit(obj);
        }else if (CompositeUnit.canInstantiate(obj)) {
    ...
    public static boolean canInstantiate(final MObject elt) {
        return ((elt instanceof DataType) && (
                ((DataType) elt).isStereotyped(ICamelDesignerPeerModule.MODULE_NAME, Dimensionless.STEREOTYPE_NAME) ||
                ((DataType) elt).isStereotyped(ICamelDesignerPeerModule.MODULE_NAME, SingleUnit.STEREOTYPE_NAME) ||
                ((DataType) elt).isStereotyped(ICamelDesignerPeerModule.MODULE_NAME, CompositeUnit.STEREOTYPE_NAME) ));
    }
