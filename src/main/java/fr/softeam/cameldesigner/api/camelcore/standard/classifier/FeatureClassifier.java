...
public abstract class FeatureClassifier extends Feature {
     ...
     */
    @objid ("1e6f95a0-8730-44da-a527-f26611da4451")
    @Override
    ...
    @objid ("273bb874-8a82-4800-b91f-bfae34d230c9")
    @Override
    public int hashCode() {
    ...
    @objid ("baa12588-97a3-4534-b37f-a8c000371158")
    ...
    public static final class MdaTypes {
        @objid ("5e98a1ef-def8-4109-bd06-f34d935203c2")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("72671328-32e4-473c-8767-9228b65ec7c7")
        private static Stereotype MDAASSOCDEP;

        @objid ("d54acea3-0490-40dc-8dae-18cae1406c80")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("67bbabd0-7a0a-4c14-8dfb-816cdd737578")
