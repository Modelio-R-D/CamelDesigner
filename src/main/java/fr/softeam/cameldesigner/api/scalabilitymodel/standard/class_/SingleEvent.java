...
public abstract class SingleEvent extends Event {
    @objid ("9656ed8d-6b64-429b-bb35-18faa397ee6a")
    public static final String STEREOTYPE_NAME = "SingleEvent";

    @objid ("ed640076-9ebb-4d13-97bd-799bfd002f73")
    @Override
     ...
     */
    @objid ("7b487464-b3a2-40b7-8d90-ce8c4d129af2")
    @Override
    public Class getElement() {
        return (Class)super.getElement();
    }

    @objid ("ceb3e5b2-09b1-42c3-b9d2-eebe93f72108")
    @Override
    public int hashCode() {
        return 23 + ((this.elt == null) ? 0 : this.elt.hashCode());
    }

    @objid ("8c77dc72-951d-4bbc-9a3a-30756fab7ba0")
    ...
    public static final class MdaTypes {
        @objid ("574ccaee-a8cc-49f5-8f98-604184f3a060")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("e87e8f91-6ae7-4b17-8004-70560bf4a67d")
        private static Stereotype MDAASSOCDEP;

        @objid ("6f951e8d-f5e6-4e70-af3c-07603e4d478e")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("abede6ea-b1c2-4c3f-a497-0a19fbf4cbcd")
