...
public abstract class SubModelImporter<T extends Model, V extends fr.softeam.cameldesigner.api.camelcore.standard.package_.SubModel> extends FeatureImporter<T,V> {
