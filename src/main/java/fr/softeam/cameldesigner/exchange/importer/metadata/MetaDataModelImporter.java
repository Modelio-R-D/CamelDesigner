...
public class MetaDataModelImporter<T extends MetaDataModel, V extends fr.softeam.cameldesigner.api.metadatamodel.standard.package_.MetaDataModel> extends SubModelImporter<T,V> {
    ...
    public void attach(V elt, CamelElement context) {
        ...
        ((CamelModel)context).addMetaDataModels(elt);
    }
