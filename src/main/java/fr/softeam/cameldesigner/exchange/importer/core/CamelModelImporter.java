...
public class CamelModelImporter<T extends CamelModel, V extends fr.softeam.cameldesigner.api.camelcore.standard.package_.SubModel> extends SubModelImporter<T,V> {
