...
public class RuleTriggerImporter<T extends RuleTrigger, V extends fr.softeam.cameldesigner.api.executionmodel.standard.class_.RuleTrigger> extends CauseImporter<T,V> {
