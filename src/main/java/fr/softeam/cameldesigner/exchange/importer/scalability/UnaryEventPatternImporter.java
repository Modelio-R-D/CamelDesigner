...
public class UnaryEventPatternImporter<T extends UnaryEventPattern, V extends fr.softeam.cameldesigner.api.scalabilitymodel.standard.class_.UnaryEventPattern> extends EventImporter<T,V> {
