...
public abstract class CamelAttributeExporter<T extends CamelAttribute> extends NamedElementExporter<T> {
    ...
    public void attach(CDOObject elt, CDOObject context) {
        if ((context instanceof camel.core.Feature)  && (elt instanceof camel.core.Attribute)){
            ((camel.core.Feature) context).getAttributes().add((camel.core.Attribute) elt);
        }
    }
