...
call mvn install:install-file -Dfile=./src/main/lib/com.google.guava-21.0.0.jar -DgroupId=com.google.guava  -DartifactId=guava  -Dversion=21.0.0  -Dpackaging=jar  
